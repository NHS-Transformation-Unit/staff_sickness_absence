...
We can break down the latest month of data, January 2025, to see the reasons recorded against staff being off with sickness. This shows that the largest reason for absence is mental health related, *Anxiety/stress/depression/other psychiatric illnesses* accounting for nearly a quarter of all days lost. Therefore, addressing the mental health and wellbeing of staff must be a priority within the ten-year plan. The chart below shows the five largest reasons for lost days:
